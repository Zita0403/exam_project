...
<section>
    ...
    <div>
        <img src="<?php print BASE_URL . 'assets/images/tisztito-arckezeles.jpg'; ?>" alt="Tisztító arckezelés">
    </div>
</section>
<section>
    ...
    <div>
        <img src="<?php print BASE_URL . 'assets/images/pigmentfolt-halvanyitas.jpg'; ?>" alt="Pigmentfolt halványítás">
    </div>
</section>
<section>
    ...
    <div>
        <img src="<?php print BASE_URL . 'assets/images/AHA-savas-hamlasztas.jpg'; ?>" alt="AHA savas hámlasztás">
    </div>
</section>
<section>
    ...
    <div>
        <img src="<?php print BASE_URL . 'assets/images/anti-aging.jpg'; ?>" alt="Anti-age kezelés 30+">
    </div>
</section>
<section>
    ...
    <div>
        <img src="<?php print BASE_URL . 'assets/images/tu-nelkuli-mezoterapia-sm.jpg'; ?>" alt="Tű nélküli mezoterápia">
    </div>
</section>
<section>
    ...
    <div>
        <img src="<?php print BASE_URL . 'assets/images/mezopen-kollagen-indukcios-kezeles.jpg'; ?>" alt="Mezopen-Kollagén indukciós terápia">
    </div>
</section>
